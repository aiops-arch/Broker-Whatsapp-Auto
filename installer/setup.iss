...
#define MyDefaultDirName "{localappdata}\BrokerDemandDesk-FreshTest-1.5.0"
#define MyOutputBaseFilename "BrokerDemandDesk-Fresh-Test-1.5.0"
#else
...
#define MyOutputBaseFilename "BrokerDemandDesk-Setup-1.5.0"
#endif
