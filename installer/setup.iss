...
#define MyDefaultDirName "{localappdata}\BrokerDemandDesk-FreshTest-1.4.0"
#define MyOutputBaseFilename "BrokerDemandDesk-Fresh-Test-1.4.0"
#else
...
#define MyOutputBaseFilename "BrokerDemandDesk-Setup-1.4.0"
#endif
