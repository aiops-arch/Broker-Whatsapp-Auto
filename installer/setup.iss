...
#define MyDefaultDirName "{localappdata}\BrokerDemandDesk-FreshTest-1.5.3"
#define MyOutputBaseFilename "BrokerDemandDesk-Fresh-Test-1.5.3"
#else
...
#define MyOutputBaseFilename "BrokerDemandDesk-Setup-1.5.3"
#endif
